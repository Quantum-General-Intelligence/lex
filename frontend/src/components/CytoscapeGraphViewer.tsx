  ...
  return (
    <div className="flex flex-col lg:flex-row gap-4 w-full relative">
      ...
      <div className={`flex-1 min-w-0 space-y-4 ${selectedNode ? 'lg:max-w-[60%]' : ''}`}>
        ...
        {/* Search Overlay */}
        {showSearch && (
          <div className="absolute inset-0 z-50 bg-vulcan-900/95 flex items-start justify-center pt-20">
      ...
      {/* Details Panel */}
      {selectedNode && (
        <div className="fixed inset-0 z-40 lg:relative lg:inset-auto lg:z-auto lg:w-[40%] lg:min-w-[350px] bg-vulcan-800 lg:bg-vulcan-800 lg:rounded-xl border-l lg:border border-vulcan-700 overflow-hidden flex flex-col h-full lg:h-[calc(100vh-320px)] lg:min-h-[400px] lg:max-h-[700px]">
          {/* Header */}
